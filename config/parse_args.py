...
def str2bool(v: str) -> bool:
    """Convert certain string values to boolean values.

    Adapted from https://stackoverflow.com/a/43357954/1361529
    """
...
def parse_args() -> configargparse.Namespace:
    """Creates a Python object using a pre-specified config file(s) (ex. seq2seq.yml).

    Returns:
        A python object that contains custom user settings. Each setting can be accessed as <this object>.setting_name.
    """
    ...
    parser.add("--use_derivitive", type=str, required=True)
